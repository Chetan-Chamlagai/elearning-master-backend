...
public class NotificationServiceImpl implements NotificationService {
  ...
  //call from other class
    ...
    public void createNotification(Integer userId, String message) {
        ...
        notificationEventProducer.publishEmail(userId, "E-Learning Notification", message);

        // Publish to Kafka -> notification-system consumer -> email
        notificationEventProducer.publishEmail(userId, "E-Learning Notification", message);
    }
    ...
    public NotificationDto createNotification(Integer userId, NotificationDto notificationDto) {
        ...
        notificationEventProducer.publishEmail(userId, "E-Learning Notification", notificationDto.getMessage());
